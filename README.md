...
For production deployment guidance, see the comprehensive documentation in the `docs/` directory:

- **[Production Overview](docs/PRODUCTION_READY.md)** - Start here for production deployment overview
- **[Secrets Management](docs/SECRETS_MANAGEMENT.md)** - How to securely store production secrets (Firebase, AWS, GCP, etc.)
- **[Deployment Checklist](docs/PRODUCTION_CHECKLIST.md)** - Complete pre-deployment, deployment, and post-deployment procedures
- **[Acceptance Testing](docs/ACCEPTANCE_TESTING.md)** - 70+ test scenarios for production validation
- **[Design Overview](docs/DESIGN_OVERVIEW.md)** - Visual design specifications

### Marketing Pages

- **Landing Page**: `/landing` - Marketing page with features, pricing, and FAQ
- **Pricing Page**: `/pricing` - Detailed pricing tiers and comparison
