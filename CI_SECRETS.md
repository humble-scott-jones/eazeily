...
gh secret set SECRET_KEY -b"ci-default-secret" --repo humble-scott-jones/swelly
gh secret set STRIPE_SECRET_KEY -b"sk_test_dummy" --repo humble-scott-jones/swelly
gh secret set STRIPE_PUBLISHABLE_KEY -b"pk_test_dummy" --repo humble-scott-jones/swelly
gh secret set STRIPE_PRICE_ID -b"price_test_dummy" --repo humble-scott-jones/swelly
gh secret set STRIPE_WEBHOOK_SECRET -b"whsec_dummy" --repo humble-scott-jones/swelly
gh secret set ADMIN_EMAILS -b"admin@example.com" --repo humble-scott-jones/swelly
