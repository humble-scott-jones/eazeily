...
const DASHBOARD_SEED_STORAGE_KEY = (typeof window !== 'undefined' && window.SEED_STORAGE_KEY) ? window.SEED_STORAGE_KEY : '__eazeily_seed_posts';
const DASHBOARD_PLAN_CACHE_KEY = 'eazeily_dashboard_plan_cache';
const DASHBOARD_PLAN_TTL_MS = 1000 * 60 * 60 * 72; // 72 hours
const PROFILE_CACHE_KEY = 'eazeily_profile_cache';
...
const GENERATED_VIEW_PREFS_KEY = 'eazeily_generated_view';
