...
# NOTE: /api/chat endpoint moved to routes/chat_routes.py for full ConversationRouter integration
# This stub has been removed to avoid conflicts. See chat_routes.py for the active implementation.
