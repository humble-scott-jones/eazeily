...
COMMAND_GUIDANCE = {
    ...
    '/templates': "📋 **Browse our content templates!**\n\nI'll show you pre-built templates for your industry. Select one by number to use it.",
}
...
class ConversationRouter:
    ...
    COMMAND_MAP = {
        ...
        '/templates': 'templates',       # Browse content templates
