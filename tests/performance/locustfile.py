"""
Locust load testing file for Swelly application.
...
class SwellyUser(HttpUser):
    """Simulates a user interacting with Swelly"""
...
#
# Mixed load (default): Just run locust and select SwellyUser
